import React, {FC, SyntheticEvent, useState, KeyboardEvent, FocusEvent} from 'react';
...
export const Header: FC<Prop> = ({ title = null, isHomePage }) => {
  ...
  // расчитываем начальное значение для инпута
  const initialValue = () => {
    ...
    <div className="container header__container">
      ...
      <div className="header__search">
        <form className="header__search-form" onSubmit={ onSubmit }>
          <input 
            type="search" className="header__search-input" 
